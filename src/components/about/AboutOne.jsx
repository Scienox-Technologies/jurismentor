...
const aboutImg1 = "/home_1/about-us-1.png";
const aboutImg2 = "/home_1/about-us-2.png";
const circleText = "/home_1/about_circle_text.svg";

export const AboutOne = () => {
  return (
    <section>
      <div className="td_height_120 td_height_lg_80" id="about" />
          ...
          <div className="row align-items-center td_gap_y_40">
            ...
            >
              <div className="td_section_heading td_style_1 td_mb_30">
                ...
                Welcome to JurisMentor Institute of Legal Science
                </h2>
                <p className="td_section_subtitle td_fs_18 mb-0">
                At JurisMentor, we are redefining legal education for the 21st century. Our institute is committed to training the next generation of legal professionals through industry-relevant courses, experienced faculty, and hands-on exposure to real-world legal systems.
                </p>
              </div>
              <div className="td_mb_40">
                <ul className="td_list td_style_5 td_mp_0">
                  <li>
                    <h3 className="td_fs_24 td_mb_8">Certificate Program</h3>
                    <p className="td_fs_18 mb-0">
                      Browse the Certificate Courses
                    </p>
                  </li>
                  <li>
                    <h3 className="td_fs_24 td_mb_8">Diploma Program</h3>
                    <p className="td_fs_18 mb-0">
                      Browse the College Partners
                    </p>
                  </li>
                </ul>
              </div>
