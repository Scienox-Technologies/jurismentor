...
const heroBg = "/home_1/head-bg.png";
        ...
        <div className="container">
          ...
          >
            ...
            <h1 className="td_hero_title td_fs_64 td_white_color td_mb_12">
              <span>JurisMentor</span> - Best Legal Education & Law Courses in India
            </h1>
            <p className="td_hero_subtitle td_fs_18 td_white_color td_opacity_7 td_mb_30">
            Build a future in law with JurisMentor Institute of Legal Science. Explore industry-led law courses, UGC-aligned certifications, and real-world legal training in India.
            </p>
            <Link
